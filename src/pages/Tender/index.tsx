            ...
            <header>
                <div className="d-flex flex-column flex-md-row align-items-left pb-3 mb-4 border-bottom">
                    <a href="/" className="d-flex align-items-center link-body-emphasis text-decoration-none">
                        ...
                        <span className="fs-4"><h1 className='h1-tender'>Orçamento</h1><strong>Finalize sua locação</strong></span>
                    </a>
                </div>
                        ...
                        <div className='mb-4'>
                            ...
                            <Form>
                                <Form.Group className="mb-2" controlId="formData1">
                                    ...
                                    <Form.Control type="date" placeholder="Informe o tempo" />
                                </Form.Group>
                            ...
                            <Button variant="outline-secondary rounded-3" type="submit">Fechar orçamento</Button>
                        </div>
                    </Col>
                </Row>
